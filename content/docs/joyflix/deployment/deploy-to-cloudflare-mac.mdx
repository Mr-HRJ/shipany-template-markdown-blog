...
### 如果你的电脑是Windows 或者 你不想每次改动后都在本地执行部署命令`pnpm cf:deploy`，那么请看这篇：[项目部署到 Cloudflare Workers（Windows)](/docs/joyflix/deployment/deploy-to-cloudflare-windows) （也适用于Mac电脑）
...
把 .env.production 文件中的环境变量值，改成你项目的线上环境真实配置值。（例如：`NEXT_PUBLIC_APP_URL`取值应该是你线上环境的域名）
...
<img src="https://pub-8dc0158e77a140d4b502b52ab75765b5.r2.dev/docs/dad6e8cf08be79a3.jpg" alt="image" />





<img src="https://pub-8dc0158e77a140d4b502b52ab75765b5.r2.dev/docs/2ac6832404ceefbc.jpg" alt="image" />
...
[如何购买便宜的域名](/docs/joyflix/others/buy-cheap-domain)
