...
### 通过`shipany-template-nano-banana`源码 去新建项目
...
请点击[项目本地开发时使用本地psql数据库](/docs/nanobanana/configuration/how-use-local-psql), 在这个页面配置好后，再回到这里继续下面的操作
...
<img src="https://pub-8dc0158e77a140d4b502b52ab75765b5.r2.dev/docs/a654d3ab3c72ef0d.png" alt="" />
...
[✨项目如何管理首页Showcases块、Showcases页、Hairstyles页数据](/docs/nanobanana/configuration/showcases-management)
...
点击查看：[✨项目中AI图片生成相关配置](/docs/nanobanana/configuration/configuration-related-to-ai-image-generation-in-the-project)
...
点击查看：[✨项目中关于Stripe支付相关配置](/docs/nanobanana/payment/stripe-configuration)
...
点击查看：[项目中关于Creem支付相关配置](/docs/nanobanana/payment/use-pay-by-creem)
...
点击查看：[项目部署到Vercel](/docs/nanobanana/deployment/deploy-to-vercel)
...
点击查看：[项目部署到 Cloudflare Workers](/docs/nanobanana/deployment/deploy-to-cloudflare-mac)
...
<img src="https://pub-8dc0158e77a140d4b502b52ab75765b5.r2.dev/docs/20ccf4d0c9dd94e8.png" alt="" />
...
<img src="https://pub-8dc0158e77a140d4b502b52ab75765b5.r2.dev/docs/006b9fe63e56dd1a.png" alt="" />
...
<img src="https://pub-8dc0158e77a140d4b502b52ab75765b5.r2.dev/docs/c01a4457640814d5.png" alt="" />
...
[✨项目可导入的表预制数据](/docs/nanobanana/configuration/preset-data)
