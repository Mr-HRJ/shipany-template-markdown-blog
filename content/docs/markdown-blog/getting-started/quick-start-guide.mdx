...
git clone git@github.com:template-code-team/shipany-template-markdown-blog.git my-shipany-project
...
git clone -b cloudflare git@github.com:template-code-team/shipany-template-markdown-blog.git my-shipany-project
...
[项目部署到Vercel](/docs/markdown-blog/deployment/deploy-to-vercel)
...
[项目部署到 Cloudflare Workers](/docs/markdown-blog/deployment/deploy-to-cloudflare-mac)
