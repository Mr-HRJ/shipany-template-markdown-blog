  ...
  const form: Form = {
    ...
    submit: {
      ...
      handler: async (data, passby) => {
        ...
        if (!user) {
          throw new Error(t('messages.no_auth'));
        }
        ...
        if (!slug?.trim() || !title?.trim()) {
          throw new Error(t('messages.slug_title_required'));
        }
        ...
        const newPost: NewPost = {
          ...
          tags: '',
          authorName: t('fields.author_name_default'),
          authorImage: '',
        ...
        if (!result) {
          throw new Error(t('add.messages.failed'));
        }
