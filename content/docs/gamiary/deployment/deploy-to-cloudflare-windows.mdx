...
按照作者提供的[Cloudflare部署文档](/docs/gamiary/deployment/deploy-to-cloudflare-mac)在Windows执行到`pnpm cf:deploy` 会先后遇到一些问题：
...

{
	...
	"name": "shipany-template-gamiary", // 这里和你项目仓库名保持一致
	...
	"vars": {
		...
		"NEXT_PUBLIC_APP_NAME":  "GamiaryTemplate",
...
## 如果你没有域名, 请阅读：[如何购买便宜的域名](/docs/gamiary/others/buy-cheap-domain)
