...
按照作者提供的[Cloudflare部署文档](/docs/markdown-blog/deployment/deploy-to-cloudflare-mac)在Windows执行到`pnpm cf:deploy` 会先后遇到一些问题：
...
## 如果你没有域名, 请阅读：[如何购买便宜的域名](/docs/markdown-blog/others/buy-cheap-domain)
