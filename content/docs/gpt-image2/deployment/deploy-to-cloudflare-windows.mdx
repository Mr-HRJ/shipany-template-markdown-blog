...
```
{
	...
	"name": "shipany-template-nano-banana",// 这里和你项目仓库名保持一致
...
//  ！！！这里是开启日志的配置 ！！！【可删除这条注释】
	...
	"vars": {
		"NEXT_PUBLIC_APP_URL": "https://my-shipany.16781678.xyz", 
		"NEXT_PUBLIC_APP_NAME": "MyShipany",
...
请阅读：[如何购买便宜的域名](/docs/gpt-image2/others/buy-cheap-domain)
